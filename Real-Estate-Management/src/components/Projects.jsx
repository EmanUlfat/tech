...
const prevProject = ()=>{
    setCurretIndex((prevIndex) => prevIndex ===0 ? projectsData.length-1 : prevIndex - 1)
}
  ...
  return (
    <motion.div 
            ...
            viewport={{once: true}} className='container mx-auto pt-20 py-4 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        {/* slider buttons */}
        <p  className='text-gray-500 max-w-80 text-center mb-8 mx-auto'>Crafting Space, Building Legacies-Explore Our Portfolio</p>
